...
'''
filepath="C:\\Users\\DIVYANSHU\\Desktop\\RASA\\RASA_projects"   
...
################################## MD&A Section #####################################################
        ...
        item7={}
        item7[1]="item 7\. managements discussion and analysis of "
        item7[2]="item 7\.managements discussion and analysis of "
        item7[3]="item7\. managements discussion and analysis of "
        item7[4]="item7\.managements discussion and analysis of "
        item7[5]="item 7\. management discussion and analysis of "
        item7[6]="item 7\.management discussion and analysis of "
        item7[7]="item7\. management discussion and analysis of "
        item7[8]="item7\.management discussion and analysis of "
        item7[9]="item 7 managements discussion and analysis of "
        item7[10]="item 7managements discussion and analysis of "
        item7[11]="item7 managements discussion and analysis of "
        item7[12]="item7managements discussion and analysis of "
        item7[13]="item 7 management discussion and analysis of "
        item7[14]="item 7management discussion and analysis of "
        item7[15]="item7 management discussion and analysis of "
        item7[16]="item7management discussion and analysis of "
        item7[17]="item 7: managements discussion and analysis of "
        item7[18]="item 7:managements discussion and analysis of "
        item7[19]="item7: managements discussion and analysis of "
        item7[20]="item7:managements discussion and analysis of "
        item7[21]="item 7: management discussion and analysis of "
        item7[22]="item 7:management discussion and analysis of "
        item7[23]="item7: management discussion and analysis of "
        item7[24]="item7:management discussion and analysis of "
        item7[25]="item7.\n\t management discussion and analysis of "
        item7[26]="item7.management s discussion and analysis of "
        item7[27]="item7. management s discussion and analysis of "
        ...
        look={" see ", " refer to ", " included in "," contained in "," discussed in ", " in item", " in part ", " and note ", " accompanying ", " read in ", " described in ", " forward looking statements "}
        ...
        for j in range(1,28):
            ...
            for m in re.finditer(item7[j], lstr1):
                if not m:
                    ...
                    substr1=lstr1[m.start()-200:m.start()]
                    substr2=lstr1[m.start():m.start()+1000]
                    if not any(s in substr1 and substr2 for s in look):   
                        #print substr1
                        b=m.start()
                        a[j].append(b)
        #print i
        ...
        for j in range(1,49):
            ...
            for m in re.finditer(item8[j], lstr1):
                if not m:
                    ...
                    substr1=lstr1[m.start()-100:m.start()]
